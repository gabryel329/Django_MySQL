...
SECRET_KEY = 'django-insecure-+**6@b(_8nav2yv44%3!2=x6cz==efj=dnj9p$$dbu6e7w_bwa'
...
TEMPLATES = [
    {
        ...
        'DIRS': ['templates'],#comunica que vai ter um diretorio templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.mysql', #Driver que o django vai utilizar MYSQL
        'NAME': 'django2',#nome do banco
        'USER': 'gabryel',#nome do usuario
        'PASSWORD': '123456',#senha do usuario
        'HOST': '127.0.0.1',#aonde esta o banco
...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')#coloca issp
